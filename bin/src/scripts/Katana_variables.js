...
<div id="theme-menu" role="menu" aria-labelledby="menu-button--menu" tabindex="-1" class="css-theme_button"
    ...
    <div class="theme-header">
        <div data-test-id="styled-text-div" color="[object Object]"><span>Display theme</span></div>
    </div>
    <div id="light-theme-button" role="menuitem" data-test-id="menu-item" class="css-menu-item">
        <div width="100%" cursor="pointer" class="css-menu-inner-item">
            <div class="inner-theme-button">
                <div class="inner-theme-button"> <svg width="24" height="24" fill="none" viewBox="0 0 24 24"
                ...
                <div>
                    <div data-test-id="styled-text-div"><span>Light theme</span></div>
                </div>
            </div>
            <div class="inner-theme-button css-theme_checkmark"> <svg id="light-theme-checkmark" style="display:none"
    ...
    <div id="dark-theme-button" role="menuitem" data-test-id="menu-item" class="css-menu-item">
        <div width="100%" cursor="pointer" class="css-menu-inner-item">
            <div class="inner-theme-button">
                <div class="inner-theme-button"><svg width="24" height="24" fill="none" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <div data-test-id="styled-text-div"><span>Dark theme</span> </div>
                </div>
            </div>
            <div class="inner-theme-button css-theme_checkmark"> <svg id="dark-theme-checkmark" style="display:none"
                    width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="m8.5 16.586-3.793-3.793a1 1 0 0 0-1.414 1.414l4.5 4.5a1 1 0 0 0 1.414 0l11-11a1 1 0 0 0-1.414-1.414L8.5 16.586Z"
    ...
    <div id="auto-theme-button" role="menuitem" data-test-id="menu-item" class="css-menu-item">
        <div width="100%" cursor="pointer" class="css-menu-inner-item">
            <div class="inner-theme-button">
                <div class="inner-theme-button"><svg width="24" height="24" fill="none" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <div data-test-id="styled-text-div"><span>Follow browser</span> </div>
                </div>
            </div>
            <div class="inner-theme-button css-theme_checkmark"> <svg id="follow-browser-checkmark"
